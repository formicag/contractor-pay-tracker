...
def lambda_handler(event, context):
    ...
    try:
        ...
        print("[VALIDATION_ENGINE] Period response received")
        period_data = period_response.get('Item', {})
        print(f"[VALIDATION_ENGINE] Period data retrieved: {bool(period_data)}")
